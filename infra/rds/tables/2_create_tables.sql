...
(2, 'Primary Care Doctor', 'Abdominal Aortic Aneurysm', 'The USPSTF recommends 1-time screening for abdominal aortic aneurysm (AAA) with ultrasonography in men aged 65 to 75 years who have ever smoked.', 'male', 65, 75, true, false, null),
...
(4, 'Oncology', 'Cervical Cancer', 'The USPSTF recommends screening for cervical cancer depending on your age range with 3 years being the average.', 'female', 21, 65, false, true, 3),
(5, 'Oncology', 'Colorectal Cancer', 'The USPSTF recommends screening for colorectal cancer in all adults aged 50 to 75 years.', 'all', 50, 75, false, true, 5),
(6, 'Primary Care Doctor', 'Depression', 'The USPSTF found convincing evidence that screening improves the accurate identification of adult patients with depression in primary care settings, including pregnant and postpartum women.', 'all', 12, 75, false, false, null),
(7, 'Primary Care Doctor', 'HIV Infection', 'CDC recommends that everyone between the ages of 13 and 64 get tested for HIV at least once as part of routine health care.', 'all', 13, 65, false, false, null),
(8, 'osteoporosis', 'Osteoporosis', 'A bone density test determines if you have osteoporosis — a disorder characterized by bones that are more fragile and more likely to break.', 'female', 65, null, false, false, null),
