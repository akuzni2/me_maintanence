...
(3, 'Primary Care Doctor', 'Basic Physical Exam', 'Exam covering the Basics · Neurological Exam. Nerves, muscle strength, reflexes, balance, and mental state may be assessed. As well as assessing risk for cardiovascular health by performing blood pressure measurements and taking blood samples to assess cholesterol.', 'all', 1, 200, false, true, 1),
...
(9, 'Dentist', 'Dental Cleaning', 'The American Dental Association recommends that you visit your dentist at least once a year to get a routine examination and cleaning', 'all', 1, 200, false, true, 1),
(10, 'Flu Shot', 'Immunization - Flu', 'The CDC recommends an annual flu vaccination for anyone 6 months of age and older.', 'all', 65, 200, false, true, 1),
...
(12, 'Primary Care Doctor', 'Immunization - Tetanus', 'CDC recommends tetanus vaccination for all babies and children, preteens and teens, and adults to protect against tetanus.', 'all', 10, 200, false, true, 10),
(13, 'Optometrist', 'Eye Exam', 'It is recommended that patients receive regular recurring eye exams.', 'all', 5, 200, false, true, 5);
